...
const Hire: React.FC = () => {
  ...
  return (
    <div id="hireme" className={`flex flex-col items-center justify-center min-h-screen border-y-2 ${border} relative ${contentBackground}`}>
      <Navbar />
      ...
      <div className={`z-50 rounded-2xl ${background} ${border} border-2 p-4 flex flex-box justify-center items-center absolute bottom-24 right-24 max-w-[900px]`}>
