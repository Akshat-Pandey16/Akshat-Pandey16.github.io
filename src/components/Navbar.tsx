...
const commonPillClass =
  'text-gray-600 text-lg cursor-pointer hover:bg-white hover:scale-105 hover:text-green-300 transition-all duration-300 rounded-full py-1 px-5 shadow-md shadow-green-500 border-4 border-green-600';
